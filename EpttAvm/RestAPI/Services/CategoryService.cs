    ...
    internal class CategoryService : ICategoryService
    {
        ...
        public async Task<CategoryResponse> SaveAsync(Category category)
        {
            ...
            catch (Exception ex)
            {
                ...
                return new CategoryResponse($"Kategori kaydedilirken hata oluştu: {ex.Message}");
            }
        }
        ...
        public async Task<CategoryResponse> UpdateAsync(int id, Category category)
        {
            ...
            if (existingCategory == null)
                return new CategoryResponse("Kategori bulunamadı.");
            ...
            {
                // Do some logging stuff
                return new CategoryResponse($"Kategori güncellenirken hata oluştu: {ex.Message}");
            }
        }
        ...
        public async Task<CategoryResponse> DeleteAsync(int id)
        {
            ...
            {
                // Do some logging stuff
                return new CategoryResponse($"Kategori silinirken hata oluştu: {ex.Message}");
            }
        }
    }
}
