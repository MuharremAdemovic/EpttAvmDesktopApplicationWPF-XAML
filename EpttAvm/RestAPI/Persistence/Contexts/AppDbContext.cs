        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            (
                ...
                new Product
                {
                    ...
                    Fiyat = 19,
                    Marka = "China",
                    Aciklama = "4 DC motoru veya 2 step motoru (unipolar veya bipolar) bunlara ek olarakda 2 servo motoru kontrol etmenize imkan sağlar.",
                    UrunResmi = ""
                },
                new Product
                {
                    ...
                    Fiyat = 15,
                    Marka = "China",
                    Aciklama = "Devrelerin Arduino ile beraber kullanılmasına imkan sağlar. ",
                    UrunResmi = ""
                },
                new Product
                {
                    ...
                    Fiyat = 15,
                    Marka = "China",
                    Aciklama = "Arduino UNO R3 modeli için tasarlanmıştır ",
                    CategoryId = 2,
                    UrunResmi = ""
                }
                );
            ...
            (
                 ...
                 {
                     Id = 1,
                     SepetKullanici = "Ali İhsan Varol",

                 },
                 new Sepet
                 {
                     Id = 2,
                     SepetKullanici = "Veli Okumuş",
            ...
            (
                ...
                new Slider { Id = 2, SliderAciklama = "Arduino Alan Herkese Arduino uyumlu Shield'ler %10 İndirimli! ", Resim = "", SliderLink = "" }
            );
            ...
            (
                ...
                new User { Id = 1, Adi = "Ali İhsan", Soyadi = "Varol", KullaniciAdi = "A.İ.Varol", Email = "aliihsanvarol@gmail.com", Sifre = 1234, Telefon = 05345674333 },
                new User { Id = 2, Adi = "Veli", Soyadi = "Okumuş", KullaniciAdi = "veliiiii", Email = "veliokumus77@gmail.com", Sifre = 4567, Telefon = 05425784124 }
            );
